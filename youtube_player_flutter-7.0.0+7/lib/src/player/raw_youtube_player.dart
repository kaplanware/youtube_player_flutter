          ...
          webController
            ...
            ..addJavaScriptHandler(
              ...
              callback: (args) {
                ...
                print("first = " + args.first.toString());
                print("LALALALLALALALALALAL");
              },
            )

            ..addJavaScriptHandler(
              handlerName: 'CaptionTypeChange',
              callback: (chc) {
                final String cpt = chc.first;
                controller.updateValue(
                  controller.value.copyWith(captionType: cpt),
                );
  ...
  String get player => '''
    ...
    <body>
        ...
        <script>
            ...
            function setCaptionType(choice) {
                player.setOption("captions", "track", {"languageCode": choice});  
                player.setOption("cc", "track", {"languageCode": choice});
                window.flutter_inappwebview.callHandler('CaptionTypeChange', choice);
                return '';
            }

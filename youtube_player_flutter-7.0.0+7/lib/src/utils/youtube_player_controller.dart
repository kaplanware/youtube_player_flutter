...
class YoutubePlayerValue {
  ...
  YoutubePlayerValue({
    ...
    this.captionType = CaptionType.en,
  ...
  /// The current video caption type defined as [CaptionType].
...
class YoutubePlayerController extends ValueNotifier<YoutubePlayerValue> {
  ...
  /// Sets the caption type for the video.
  void setCaptionType(String cc) {
    _callMethod('setCaptionType("$cc")');
    print(cc);
  }
